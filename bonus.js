...
function getRandomArbitrary() {
    let aux = Math.floor(Math.random()*10)%5;
    return options[aux];
}
...
function compare(userSelection, computerSelection){
    const result = {
        'paper': {'paper': "Tie!",'rock':"You win!",'scissor':"You lose :(",'spock':'You win!','lizard':'You lose :('},
        'rock': { 'rock': "Tie!",'scissor':"You win!",'paper':"You lose :(",'lizard':'You win!','spock':'You lose :('},
        'scissor':{'scissor': "Tie!",'paper':"You win!",'rock':"You lose :(",'lizard':'You win!','spock':'You lose :('},
        'spock':{'spock': "Tie!",'scissor':"You win!",'lizard':"You lose :(",'rock':'You win!','paper':'You lose :('},   
        'lizard':{'lizard': "Tie!",'paper':"You win!",'scissor':"You lose :(",'spock':'You win!','rock':'You lose :('}  
    }
...
function showGame(){
    if(window.screen.width <= 349){
        $(".btn-container").first().css("marginTop","300px");
    }
    else if(window.screen.width>349 && window.screen.width<=500){
        $(".btn-container").first().css("marginTop","400px");
    }
    else{
        $(".btn-container").first().css("marginTop","500px");
    };
